...
"color:white")
        ...
        self.textBrowser.setMinimumSize(QtCore.QSize(200, 540))
...
"border-color: rgb(40,40,40)")
        ...
        self.gridLayout.setColumnMinimumWidth(0, 480)
        self.gridLayout.setColumnMinimumWidth(1, 480)
        self.gridLayout.setRowMinimumHeight(0, 270)
        self.gridLayout.setRowMinimumHeight(1, 270)
        self.gridLayout_2.addLayout(self.gridLayout, 0, 0, 1, 1)
        self.gridLayout_2.setColumnStretch(0, 960)
        MainWindow.setCentralWidget(self.centralwidget)
        self.statusbar = QtWidgets.QStatusBar(MainWindow)
        self.statusbar.setObjectName("statusbar")
        MainWindow.setStatusBar(self.statusbar)
        self.menubar = QtWidgets.QMenuBar(MainWindow)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1188, 24))
